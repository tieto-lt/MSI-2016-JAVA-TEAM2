...
function carouselCtrl ($scope,missionService) {
...
carouselCtrl.$inject = ['$scope','MissionService'];

angular.module('ui.bootstrap').controller('CarouselDemoCtrl',carouselCtrl);
